1. **Игровой процесс.**
   ...
   7. **Регистрация, покупка и передача твинков (вторых аккаунтов); постоянная игра с неосновного аккаунта на сервере.**
	  ...
	  <note><new>*Примечание: Однократный вход на чужой аккаунт с целью совершения кратковременных (около 5 минут) действий, например - выкладка вещей из инвентаря или эндерсундука по просьбе владельца, если у того нет доступа к устройству, не является нарушением данного правила.*</new></note>
...
2. **Общение.**
   ...
   2. **Спам сообщениями в чат.**
	  ...
	  2. **Спам сообщениями о входе и выходе на сервер.**
   ...
   5. **Провокационное; неадекватное; агрессивное; вызывающее; и антисоциальное поведение, а также формирование подобной среды в сообществе проекта.**
	  ...
	  Наказание: бан от 5 до 7 дней, далее вечный бан.
