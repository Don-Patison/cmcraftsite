...
- Для объявления войны вы должны создать дискорд-тикет (канал #открыть-тикет) и уведомить админов, чтобы они смогли пронаблюдать за процессом и пресечь нарушения правил.
...
4. Игроки на поле боя, которые не являются членами армии, добровольческих подразделений, служб снабжения и не записались на участие в войне до её начала. В том числе боевики, террористы, мародеры, бандиты (так называемые «нейтралаы»), кроме тех, что одеты в белую кожаную броню.
